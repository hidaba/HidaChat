...
2. Report the vulnerability privately by opening a [Private Security Advisory](https://github.com/hidaba/HidaChat/security/advisories/new) on GitHub or contacting the maintainer directly via GitHub profile.
...
## Security Practices in HidaChat
...
- **GitHub Release Verification**: Automatic updates use HTTPS calls directly to `https://api.github.com/repos/hidaba/HidaChat/releases/latest`.
