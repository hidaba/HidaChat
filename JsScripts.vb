...
Public Class TranslationJsScripts
  ...
  window.onTranslationReceived = function(transId, translatedText, isSuccess) {
    ...
    Public Shared Function GetTranslationJS(
        ...
        Dim sb As New System.Text.StringBuilder(<js><![CDATA[
(function() {
  ...
  $$FULL_PAGE_INIT$$
        ...
        sb.Replace("$$ENABLE_HOVER$$", enableHover.ToString().ToLower())
        sb.Replace("$$HOVER_CLASS_CMD$$", hoverClassListCmd)
        sb.Replace("$$STYLES$$", TranslationStyles)
        sb.Replace("$$HOVER_BTN$$", TranslationHoverButton)
        sb.Replace("$$BUBBLE_UI$$", TranslationBubbleUI)
        sb.Replace("$$ALL_MSG_JS$$", TranslateAllMessagesJS)
        sb.Replace("$$ENGINE_JS$$", TranslationEngineJS)
        sb.Replace("$$CALLBACKS_JS$$", TranslationCallbacksJS)
