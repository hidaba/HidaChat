...
Public Class AppLocalizations
    ...
    Public Shared ReadOnly EnStrings As New Dictionary(Of String, String)(StringComparer.OrdinalIgnoreCase) From {
        ...
        {"max_accounts_downgrade_notice", "Downgrade notice: you have {count} active accounts, exceeding the maximum limit of {max}. Existing accounts are preserved and fully functional, but adding new accounts is disabled until you are below the limit."},
        {"accounts_downgrade_blocked", "Cannot add account: you have {count} configured accounts, exceeding the current limit of {max}. Delete one or more accounts or increase the limit to add new accounts."},
        ...
        {"add_hermes_account", "Add Hermes Agent account"},
        ...
        {"app_description", "Portable, lightweight, multi-account desktop client for Windows (WhatsApp, Telegram, OpenClaw, Hermes)."},
        {"author", "Author"},
        ...
        {"update_already_latest", "You already have the latest version (v{version})!"},
        {"update_already_latest_title", "Up to Date"},
        {"update_no_new_version", "The remote version (v{remote}) is older than or equal to current version (v{current})."},
        {"update_no_new_version_title", "Update"},
        {"update_available_prompt", "A new version of HidaChat (v{version}) is available!" & vbCrLf & vbCrLf & "Would you like to download and install the update now?"},
        {"update_available_title", "Update Available"},
        {"update_install_error", "An error occurred while installing the update:" & vbCrLf & vbCrLf & "{error}"},
        {"update_install_error_title", "Update Error"},
        {"update_check_failed", "Failed to check for updates:" & vbCrLf & vbCrLf & "{error}"},
        {"update_check_failed_network", "Unable to check for updates. Please check your internet connection or try again later."},
        {"update_check_failed_title", "Update Check"},
        {"update_no_asset", "No update package is attached to the remote release."},
        {"settings_corrupt_recovery_title", "Settings Recovery"},
    ...
    Public Shared ReadOnly ItStrings As New Dictionary(Of String, String)(StringComparer.OrdinalIgnoreCase) From {
        ...
        {"add_hermes_account", "Aggiungi account Hermes Agent"},
        {"openclaw_server_url", "URL Gateway / Tailscale:"},
        {"openclaw_auth_token", "Token di Autenticazione Gateway:"},
        {"test_connection", "Verifica Connessione"},
        {"connection_testing", "Verifica in corso..."},
        {"connection_success", "✓ In linea"},
        ...
        {"delete_account_last", "Non è possibile eliminare l'unico account attivo."},
        {"cancel", "Annulla"},
        {"delete", "Elimina"},
        {"rename", "Rinomina"},
        {"language", "Lingua"},
        ...
        {"exit", "Esci"},
        {"translate_message_button", "Pulsante traduci messaggio"},
        {"keep_app_in_english", "Mantieni interfaccia in inglese"},
        {"full_page_translation", "Traduci l'intera pagina"},
        {"show_translate_all_messages_button", "Pulsante traduci tutto nella barra del titolo"},
        {"reload_active_tab", "Ricarica scheda attiva"},
        {"use_beta_channel", "Usa canale di aggiornamento beta"},
        ...
        {"max_accounts_downgrade_notice", "Avviso di downgrade: sono presenti {count} account attivi rispetto al limite massimo di {max}. Gli account esistenti restano attivi e funzionanti, ma non sarà possibile aggiungerne di nuovi finché non si rientra nel limite."},
        {"accounts_downgrade_blocked", "Impossibile aggiungere un account: sono presenti {count} account rispetto al limite massimo impostato di {max}. Rimuovi uno o più account o aumenta il limite per poterne aggiungere altri."},
        {"max_accounts", "Max account:"},
        {"about", "Informazioni"},
        {"about_title", "Informazioni su HidaChat"},
        {"app_description", "Client desktop Windows portatile, leggero e multi-account (WhatsApp, Telegram, OpenClaw, Hermes)."},
        {"author", "Autore"},
        {"release_date", "Data di rilascio"},
        {"license", "Licenza"},
        {"runtime_environment", "Ambiente e Framework"},
        {"portable_directory", "Percorso Dati Portatile"},
        {"github_repository", "Repository GitHub"},
        {"report_issue", "Segnala Problema"},
        {"view_releases", "Visualizza Release"},
        {"bulk_sender", "Invio Massivo Excel / CSV"},
        {"custom_css", "CSS Personalizzato"},
        {"enable_custom_css", "Abilita regole CSS personalizzate"},
        {"custom_css_placeholder", "/* Inserisci qui il tuo CSS personalizzato per WhatsApp e Telegram Web */"},
        ...
        {"spellchecker_lang_auto", "Automatica (segue la lingua dell'app)"},
        {"spellchecker_restart_hint", "Le modifiche avranno effetto ricaricando le schede o riavviando HidaChat."},
        {"dnd_mode", "Non Disturbare (Focus Mode)"},
        {"dnd_enable", "Disattiva tutte le notifiche e i suoni"},
        {"dnd_duration", "Durata"},
        {"dnd_30m", "Per 30 minuti"},
        {"dnd_1h", "Per 1 ora"},
        {"dnd_2h", "Per 2 ore"},
        {"dnd_8h", "Per 8 ore"},
        {"dnd_indefinite", "Fino a disattivazione"},
        {"dnd_active_until", "Non Disturbare attivo fino alle {time}"},
        {"dnd_active_indefinite", "Non Disturbare attivo (indefinito)"},
        {"update_insufficient_permissions", "Impossibile aggiornare automaticamente." & vbCrLf & "L'applicazione non dispone dei permessi di scrittura nella cartella di installazione." & vbCrLf & vbCrLf & "Sposta l'applicazione in una cartella scrivibile dall'utente (es. Documenti, Desktop, o cartella su chiavetta USB)." & vbCrLf & "Evita directory di sistema protette come Programmi." & vbCrLf & vbCrLf & "Versione disponibile: v{version}"},
        ...
        {"update_already_latest", "Hai già la versione più recente (v{version})!"},
        {"update_already_latest_title", "Aggiornato"},
        {"update_no_new_version", "La versione remota (v{remote}) è precedente o uguale a quella corrente (v{current})."},
        {"update_no_new_version_title", "Aggiornamento"},
        {"update_available_prompt", "È disponibile una nuova versione di HidaChat (v{version})!" & vbCrLf & vbCrLf & "Desideri scaricare ed installare l'aggiornamento ora?"},
        {"update_available_title", "Aggiornamento Disponibile"},
        {"update_install_error", "Errore durante l'installazione dell'aggiornamento:" & vbCrLf & vbCrLf & "{error}"},
        {"update_install_error_title", "Errore Aggiornamento"},
        {"update_check_failed", "Errore durante la verifica degli aggiornamenti:" & vbCrLf & vbCrLf & "{error}"},
        {"update_check_failed_network", "Impossibile verificare la presenza di aggiornamenti. Verifica la connessione Internet o riprova più tardi."},
        {"update_check_failed_title", "Verifica Aggiornamenti"},
        {"update_no_asset", "Nessun pacchetto di aggiornamento valido allegato alla versione remota."},
        {"settings_corrupt_recovery_title", "Ripristino Impostazioni"},
    ...
    Public Shared ReadOnly FrStrings As New Dictionary(Of String, String)(StringComparer.OrdinalIgnoreCase) From {
        ...
        {"add_hermes_account", "Ajouter un compte Hermes Agent"},
        ...
        {"max_accounts_downgrade_notice", "Avis de déclassement : vous avez {count} comptes actifs dépassant la limite maximale de {max}. Les comptes existants sont conservés et opérationnels, mais l'ajout de nouveaux comptes est désactivé jusqu'à ce que vous soyez sous la limite."},
        {"accounts_downgrade_blocked", "Impossible d'ajouter un compte : vous avez {count} comptes configurés pour une limite de {max}. Supprimez un ou plusieurs comptes ou augmentez la limite pour en ajouter de nouveaux."},
        {"max_accounts", "Comptes maximum :"},
        {"about", "À propos"},
        {"about_title", "À propos de HidaChat"},
        {"app_description", "Client de bureau multi-comptes léger et portable pour Windows (WhatsApp, Telegram, OpenClaw, Hermes)."},
        {"author", "Auteur"},
        ...
        {"update_already_latest", "Vous disposez déjà de la version la plus récente (v{version}) !"},
        {"update_already_latest_title", "À jour"},
        {"update_no_new_version", "La version distante (v{remote}) est antérieure ou égale à la version actuelle (v{current})."},
        {"update_no_new_version_title", "Mise à jour"},
        {"update_available_prompt", "Une nouvelle version de HidaChat (v{version}) est disponible !" & vbCrLf & vbCrLf & "Souhaitez-vous télécharger et installer la mise à jour maintenant ?"},
        {"update_available_title", "Mise à jour disponible"},
        {"update_install_error", "Une erreur est survenue lors de l'installation de la mise à jour :" & vbCrLf & vbCrLf & "{error}"},
        {"update_install_error_title", "Erreur de mise à jour"},
        {"update_check_failed", "Échec de la recherche de mises à jour :" & vbCrLf & vbCrLf & "{error}"},
        {"update_check_failed_network", "Impossible de vérifier les mises à jour. Veuillez vérifier votre connexion Internet ou réessayer plus tard."},
        {"update_check_failed_title", "Vérification des mises à jour"},
        {"update_no_asset", "Aucun package de mise à jour n'est associé à la version distante."},
        {"settings_corrupt_recovery_title", "Récupération des Paramètres"},
    ...
    Public Shared ReadOnly EsStrings As New Dictionary(Of String, String)(StringComparer.OrdinalIgnoreCase) From {
        ...
        {"add_hermes_account", "Añadir cuenta de Hermes Agent"},
        {"openclaw_server_url", "URL Gateway / Tailscale:"},
        ...
        {"max_accounts_downgrade_notice", "Aviso de reducción: tiene {count} cuentas activas, superando el límite máximo de {max}. Las cuentas existentes se mantienen operativas, pero no se pueden añadir nuevas cuentas hasta que esté por debajo del límite."},
        {"accounts_downgrade_blocked", "No se puede añadir una cuenta: tiene {count} cuentas configuradas para un límite de {max}. Elimine una o más cuentas o aumente el límite para añadir más."},
        {"max_accounts", "Cuentas máximas:"},
        {"about", "Acerca de"},
        {"about_title", "Acerca de HidaChat"},
        {"app_description", "Cliente de escritorio multicuenta ligero y portátil para Windows (WhatsApp, Telegram, OpenClaw, Hermes)."},
        {"author", "Autor"},
        ...
        {"update_already_latest", "¡Ya tiene la versión más reciente (v{version})!"},
        {"update_already_latest_title", "Actualizado"},
        {"update_no_new_version", "La versión remota (v{remote}) es anterior o igual a la actual (v{current})."},
        {"update_no_new_version_title", "Actualización"},
        {"update_available_prompt", "¡Hay una nueva versión de HidaChat (v{version}) disponible!" & vbCrLf & vbCrLf & "¿Desea descargar e instalar la actualización ahora?"},
        {"update_available_title", "Actualización disponible"},
        {"update_install_error", "Ocurrió un error al instalar la actualización:" & vbCrLf & vbCrLf & "{error}"},
        {"update_install_error_title", "Error de actualización"},
        {"update_check_failed", "Error al comprobar actualizaciones:" & vbCrLf & vbCrLf & "{error}"},
        {"update_check_failed_network", "No se pudieron comprobar las actualizaciones. Compruebe su conexión a Internet o inténtelo de nuevo más tarde."},
        {"update_check_failed_title", "Comprobación de actualizaciones"},
        {"update_no_asset", "No hay ningún paquete de actualización adjunto a la versión remota."},
        {"settings_corrupt_recovery_title", "Recuperación de Configuración"},
    ...
    Public Shared ReadOnly DeStrings As New Dictionary(Of String, String)(StringComparer.OrdinalIgnoreCase) From {
        ...
        {"add_hermes_account", "Hermes Agent-Konto hinzufügen"},
        {"openclaw_server_url", "Gateway- / Tailscale-URL:"},
        ...
        {"max_accounts_downgrade_notice", "Downgrade-Hinweis: Sie haben {count} aktive Konten und überschreiten das Limit von {max}. Vorhandene Konten bleiben erhalten und funktionsfähig, das Hinzufügen neuer Konten ist jedoch gesperrt, bis das Limit unterschritten wird."},
        {"accounts_downgrade_blocked", "Konto kann nicht hinzugefügt werden: Sie haben {count} konfigurierte Konten bei einem Limit von {max}. Entfernen Sie Konten oder erhöhen Sie das Limit, um weitere hinzuzufügen."},
        {"max_accounts", "Maximale Konten:"},
        {"about", "Über"},
        {"about_title", "Über HidaChat"},
        {"app_description", "Portabler, schlanker Multi-Account-Desktop-Client für Windows (WhatsApp, Telegram, OpenClaw, Hermes)."},
        {"author", "Autor"},
        ...
        {"update_already_latest", "Sie haben bereits die neueste Version (v{version})!"},
        {"update_already_latest_title", "Auf dem neuesten Stand"},
        {"update_no_new_version", "Die Remote-Version (v{remote}) ist älter oder gleich der aktuellen Version (v{current})."},
        {"update_no_new_version_title", "Aktualisierung"},
        {"update_available_prompt", "Eine neue Version von HidaChat (v{version}) ist verfügbar!" & vbCrLf & vbCrLf & "Möchten Sie das Update jetzt herunterladen und installieren?"},
        {"update_available_title", "Update verfügbar"},
        {"update_install_error", "Beim Installieren des Updates ist ein Fehler aufgetreten:" & vbCrLf & vbCrLf & "{error}"},
        {"update_install_error_title", "Update-Fehler"},
        {"update_check_failed", "Fehler beim Prüfen auf Updates:" & vbCrLf & vbCrLf & "{error}"},
        {"update_check_failed_network", "Updates konnten nicht geprüft werden. Bitte überprüfen Sie Ihre Internetverbindung oder versuchen Sie es später erneut."},
        {"update_check_failed_title", "Update-Prüfung"},
        {"update_no_asset", "Dem Remote-Release ist kein Update-Paket beigefügt."},
        {"settings_corrupt_recovery_title", "Wiederherstellung der Einstellungen"},
